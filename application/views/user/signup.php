...
<?php echo form_label('Adınızı giriniz', 'firstname'); ?>
...
<?php echo form_label('Soyadınızı giriniz', 'lastname'); ?>
...
<?php echo form_label('Email adresinizi giriniz', 'emailid'); ?>
...
<?php echo form_label('Telefon numarası', 'mobilenumber'); ?>
...
<?php echo form_label('Tekrar şifre', 'confirmpassword'); ?>
<?php echo form_error('confirmpassword',"<div style='color:red'>","</div>");?>
                  </div>
                </div>
              </div>
            </div>
 <?php echo form_submit(['name'=>'Kayıt Ol','value'=>'Kayıt Ol','class'=>'btn btn-primary btn-block']); ?>

          </form>
          <div class="text-center">
            <a class="d-block small mt-3" href="<?php echo site_url('user/Login'); ?>">Giriş</a>
